...
public class SearchByKeywordStory {
    ...
    @Test
    public void searching_by_keyword_java_should_display_the_corresponding_article() {
        anna.is_the_home_page();
        anna.looks_for("java");
        anna.should_see_definition("A blend of coffee imported from the island of Java.");
    }
